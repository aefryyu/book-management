...
import static com.ali.order.testdata.TestDataFactory.*;
...
public class OrderControllerUnitTest {
    ...
    @MockBean // @ReplaceWithMock use this if you're using spring ver 3.5.x
    ...
    @BeforeEach
    void setUp() {
        given(securityService.getLoginUserName()).willReturn("intan");
    }
    ...
    void shouldReturnBadRequestWhenOrderPayloadIsInvalid(CreateOrderRequest request) throws Exception {
        given(orderService.createOrder(eq("intan"), any(CreateOrderRequest.class)))
                .willReturn(null);
